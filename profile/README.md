...
| --- | --- | --- |
| Prompt Galleries | [awesome-gpt-image-2-prompts](https://github.com/HiAPIAI/awesome-gpt-image-2-prompts) | Study output-backed GPT Image 2 recipes, open them in HiAPI Draw, and adapt prompts for your own assets |
...
- **Prompt gallery:** use [awesome-gpt-image-2-prompts](https://github.com/HiAPIAI/awesome-gpt-image-2-prompts) when you want a tested visual recipe before generating.
...
| 你需要什么 | 仓库 / 链接 | 用途 |
| --- | --- | --- |
| Prompt Galleries | [awesome-gpt-image-2-prompts](https://github.com/HiAPIAI/awesome-gpt-image-2-prompts) | 查看带真实效果图的 GPT Image 2 创意配方，在 HiAPI Draw 打开并改写 |
...
- **Prompt gallery：** 如果想先找一个验证过的视觉配方，查看 [awesome-gpt-image-2-prompts](https://github.com/HiAPIAI/awesome-gpt-image-2-prompts)。
